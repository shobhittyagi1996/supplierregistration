		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#comsapsupplierregistration-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsapsupplierregistration-display": {
								"semanticObject": "comsapsupplierregistration",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.supplierregistration",
									"url": sap.ui.require.toUrl("com/sap/supplierregistration")
								}
							}
						}
					}
